...
export type PlayerProps = {
    ...
    sx?: object;
    /**
     * - Mobile drawer is activated when player is too small to contain all the controls. It is likely you would want this feature disabled if you render the Player in the normal document flow or want to use Player as widget in your app.
     */
 ...
 */
declare function Player(props?: PlayerProps): JSX.Element;
import { Track } from "./redux/types.js";
/**@deprecated use "Track"" instead*/
export const TrackModel: typeof Track;
import PlayerInterface from "./interface.js";
import { RepeatMode as RepeatModes } from "./redux/types.js";
export { Track, PlayerInterface, RepeatModes };
